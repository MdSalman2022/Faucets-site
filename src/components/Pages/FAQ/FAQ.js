...
const FAQ = () => {
    return (
        <div className='container'>
            ...
            <Accordion>
                <Accordion.Item eventKey="0" className='mt-2 border'>
                    <Accordion.Header > <span className='fw-bold'>What is a blockchain oracle?</span> </Accordion.Header >
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="1" className='mt-2 border'>
                    <Accordion.Header > <span className='fw-bold'>Why do blockchain need oracles?</span> </Accordion.Header >
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="2" className='mt-2 border'>
                    <Accordion.Header > <span className='fw-bold'>What is the Chainlink Network?</span> </Accordion.Header >
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="3" className='mt-2 border'>
                    <Accordion.Header > <span className='fw-bold'>Where can i explore the performance and reliablity of the Chainlink Network?</span> </Accordion.Header >
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="4" className='mt-2 border'>
                    <Accordion.Header > <span className='fw-bold'>What is Chainlink Verfiable Random Function (VRF)?</span> </Accordion.Header >
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="5" className='mt-2 border'>
                    <Accordion.Header > <span className='fw-bold'>What is Chainlink Proof of Reserve?</span> </Accordion.Header >
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="6" className='mt-2 border'>
                    <Accordion.Header > <span className='fw-bold'>Who can use Chainlink?</span> </Accordion.Header >
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="7" className='mt-2 border'>
                    <Accordion.Header > <span className='fw-bold'>How do i keep up with current protocol development?</span> </Accordion.Header >
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="8" className='mt-2 border'>
                    <Accordion.Header > <span className='fw-bold'>How can i reach out to Chainlink for support?</span> </Accordion.Header >
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="9" className='mt-2 border'>
                    <Accordion.Header> <span className='fw-bold'>How do i participate in building Chainlink?</span> </Accordion.Header>
                    <Accordion.Body>
